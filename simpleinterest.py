...
def calculate_interest():
    ...
    message=Label(result_frame,text="Interest on Ds."+str(p)+" at rate of interest "+str(r)+"% for "+str(t)+" years is Ds."+str(interest), bg = "grey", font=("Calibri", 12), width=55)
...
principle_label=Label(window, text="Principle in Ds", fg = "black", bg = "grey", font=("Calibri", 12),bd=1)
